...
// Dynamically set the refresh interval based on environment
...
export default function AIThinking() {
    ...
    return (
        <div className="flex items-center justify-center space-x-2 text-white">
            ...
            {/* Tailwind spinner */}
            <div
                className="inline-block w-4 h-4 border-2 border-t-2 border-gray-300 rounded-full animate-spin border-t-blue-500"></div>
        </div>
    );
}
